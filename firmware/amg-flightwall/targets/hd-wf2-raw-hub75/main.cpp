...
constexpr gpio_num_t kR1 = GPIO_NUM_2;
constexpr gpio_num_t kG1 = GPIO_NUM_6;
constexpr gpio_num_t kB1 = GPIO_NUM_10;
constexpr gpio_num_t kR2 = GPIO_NUM_3;
constexpr gpio_num_t kG2 = GPIO_NUM_7;
constexpr gpio_num_t kB2 = GPIO_NUM_11;
...
class RawHub75Diagnostic final {
 public:
  void setup() noexcept {
    ...
    Serial.println("RAW HUB75: 128x64, 1/32 scan, X1 pin profile");
